    ...
    return (
        ...
        >
            <Flex
                ...
                alignItems={'center'}
            >
                <Heading as='h3' ml={{ base: 0, sm: 8 }} size='lg' fontWeight={'thin'} color='black' style={{ fontFamily: "Pacifico" }}>Resume Builder</Heading>
                <Spacer></Spacer>
                <HStack spacing={10} mr={{ base: 0, sm: 8 }} as='nav' style={{ fontFamily: 'Poppins' }}>
                    ...
                    <Button colorScheme={'black'} fontWeight={'medium'}>Contact</Button>
                </HStack>
            </Flex>
